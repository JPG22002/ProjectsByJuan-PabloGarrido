...
public class CashRegister {
    ...
    public void processMerchandise(){
        ...
        System.out.println("What sort of merchandise are you buying?");
        ...
        keyboard.nextLine();
        System.out.println("How many of that item?");
...
//                if(merchSize.equalsIgnoreCase("S")){
//                cost = 7.50;
//                }
//                else if(merchSize.equalsIgnoreCase("M")){
//                cost = 9.50;
//                }
//                else if(merchSize.equalsIgnoreCase("L")){
//                cost = 11.50;
//                }
//        }
//        else if(merchName.equalsIgnoreCase("pants")){
//             if(merchSize.equalsIgnoreCase("S")){
//                cost = 7.75;
//                }
//                else if(merchSize.equalsIgnoreCase("M")){
...
//            
//        }
//        else if(merchName.equalsIgnoreCase("bracelet")||merchName.equalsIgnoreCase("necklace")){
//            
//                cost = 5.25;
//        }
//        else{
...
//        }
        ...
        aMerchandise = new Merchandise(merchSize, merchName, price, quantity);
